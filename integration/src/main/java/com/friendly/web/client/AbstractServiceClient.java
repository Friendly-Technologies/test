...
import com.friendly.web.client.util.QueryModifierBuilder;
...
import static com.friendly.web.client.ClientErrorRegistry.*;
...
public abstract class AbstractServiceClient {
    ...
    private void handleResponseCode(final CloseableHttpResponse response,
        ...
        if (ALLOWED_ERROR_CODES.contains(statusCode)) {
            try {
                ...
                throw new InternalServerException(CLIENT_ERROR_EXECUTING_COLLECTION_REQUEST);
            }
        }
    }
    ...
    private List<ErrorApi> getErrorsByJsonResponse(final ObjectMapper objectMapper, final String jsonResponse)
        ...
        if (StringUtils.isBlank(jsonResponse)) {
            final ErrorApi error = ErrorApi.builder(CLIENT_EMPTY_RESPONSE.getErrorMessage(),
                    CLIENT_EMPTY_RESPONSE.getErrorCode())
                                           .build();
    ...
    private void processError(final int statusCode,
        ...
        switch (statusCode) {
            ...
            default:
                throw new InternalServerException(CLIENT_UNSUPPORTED_STATUS_CODE, statusCode);
        }
    }
